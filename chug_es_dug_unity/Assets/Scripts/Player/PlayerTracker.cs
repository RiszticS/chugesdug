...
public class PlayerTracker : MonoBehaviour
{
    ...
    public Vector3 GetProjectedPosition(float fTime)
    {
        ...
        //X0 + v0 * t + 1/2 a t^2
        v3Ret = goTrackingObject.transform.position + (v3AverageVelocity * Time.deltaTime * (fTime / Time.deltaTime)) + (0.5f * v3AverageAcceleration * Time.deltaTime * Mathf.Pow(fTime / Time.deltaTime,0.9f));
